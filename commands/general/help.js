...
module.exports.run = async (bot, message, args) => {
    ...
    if(mod){
        message.author.send({embed: {
            ...
            title: `Guardian Angel (GA) | Commands`,
            description: (`Guardian Angel is a custom bot, being designed to serve this server and possibly others in the future. I am being programmed to hopefully advance far enough to take priority over most of the other popular bots.\n • Type \`&help <command>\` for more info on that command!
